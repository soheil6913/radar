    ...
    suspend fun getTacticalAnalysis(
        ...
        val request = GeminiRequest(
            ...
            systemInstruction = GeminiContent(
                parts = listOf(
                    GeminiPart(
                        text = "شما تحلیلگر ارشد هوش مصنوعی و ژئوفیزیک رادار طلایاب پیشرفته GOLD RADAR X20 هستید. تمامی پاسخ‌های شما باید الزامی و ۱۰۰٪ به زبان فارسی شیوا، روان، علمی، تخصصی و کاربردی باشد. از به کار بردن هرگونه کلمه، اصطلاح یا جملات عربی کاملاً خودداری نمایید. تمامی گزارش‌ها، تحلیل آنومالی‌ها، شناسایی فلزات و حفره‌ها باید بر اساس استاندارد فارسی ارائه شوند."
                    )
                )
            )
        )
